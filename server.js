...
app.post('/api/garajes', (req, res) => {
  ...
  uploader(req, res, async (err) => {
    ...
    const { usuario_id, direccion, descripcion, precio_hora, hora_apertura, hora_cierre, dias_operativos } = req.body;
    let espacios = [];
    try {
    ...
    try {
      ...
      const insertResult = await db.request()
        ...
        .query(`
          INSERT INTO Garajes (anfitrion_id, direccion, descripcion, precio_hora, tipo_vehiculo, hora_apertura, hora_cierre, dias_operativos)
          VALUES (@anfitrion_id, @direccion, @descripcion, @precio_hora, @tipo_vehiculo, @hora_apertura, @hora_cierre, @dias_operativos);
...
app.post('/api/reservas', async (req, res) => {
  ...
  try {
    ...
    const garajeResult = await db.request()
      ...
      .query(`
        SELECT g.precio_hora, g.hora_apertura, g.hora_cierre, g.dias_operativos
        FROM Espacios e 
